...
The third one tells the angle in 2 situations: Probing (165Âº) and resting (60Âº). Check this with command M280 P0 S{angle} (example: M280 P0 S60 moves the servo to 60Âº)
